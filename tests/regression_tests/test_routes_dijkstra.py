...
TEST_ROUTES = [
    ...
    './example_routes/dijkstra/fuel/centre_onestart_multiend.json',
    './example_routes/dijkstra/fuel/offcentre_onestart_multiend.json',
    ...
    './example_routes/dijkstra/time/centre_onestart_multiend.json',
    './example_routes/dijkstra/time/offcentre_onestart_multiend.json',
]
