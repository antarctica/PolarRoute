...
Throughout this section we will outline the use case for the Discrete Meshing of the environment. The two main classes used are `CellGrid` composed of a series of `CellBox` objects.

A general overview of the method can be seen in
