...
class DataLoaderFactory:
    ...
    def get_dataloader(name, file_location, **kwargs):
        # TODO Replace **kwargs with params
        if   name == 'GEBCO': return GEBCO_DataLoader(file_location, **kwargs)
        elif name == 'AMSR':  return AMSR_DataLoader(file_location, **kwargs)
        elif name == 'SOSE':  return SOSE_DataLoader(file_location, **kwargs)
        # elif ...
...
if __name__=='__main__':
    ...
    gebco = factory.get_dataloader('GEBCO', 
                                'PolarRoute/datastore/bathymetry/GEBCO/gebco_2022_n-40.0_s-90.0_w-140.0_e0.0.nc', 
                                    min_dp = 5,
                                    ds=(5,5), 
                                    data_name="elevation", 
                                    aggregate_type="MAX"
