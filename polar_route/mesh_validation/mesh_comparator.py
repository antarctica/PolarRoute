...
class MeshComparator:
    ...
    def compare_all(self, mesh_a, mesh_b):
        ...
        self.compare_neighbour_graphs(mesh_a, mesh_b)
    
    def compare_cellboxes(self, mesh_a, mesh_b):
        self.compare_cellbox_attributes(mesh_a, mesh_b)
        self.compare_cellbox_boundaries(mesh_a, mesh_b)
        self.compare_cellbox_count(mesh_a, mesh_b)
        self.compare_cellbox_ids(mesh_a, mesh_b)
        self.compare_cellbox_values(mesh_a, mesh_b)
    
    def compare_neighbour_graphs(self, mesh_a, mesh_b):
        self.compare_neighbour_graph_count(mesh_a, mesh_b)
        self.compare_neighbour_graph_ids(mesh_a, mesh_b)
        self.compare_neighbour_graph_values(mesh_a, mesh_b)
    ...
    @staticmethod
    def compare_cellbox_boundaries(mesh_a, mesh_b):
        pass
